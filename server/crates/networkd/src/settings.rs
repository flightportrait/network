...
pub struct Settings {
    ...
    pub routes_rate_limit: usize,
    pub gaps_rate_limit: usize,
    pub flight_rate_limit: usize,
    pub airframe_rate_limit: usize,
...
impl Settings {
    pub fn from_env() -> Settings {
        Settings {
            ...
            gaps_rate_limit: int("NETWORK_API_GAPS_RATE_LIMIT", 300) as usize,
            routes_rate_limit: int("NETWORK_API_ROUTES_RATE_LIMIT", 120) as usize,
            flight_rate_limit: int("NETWORK_API_FLIGHT_RATE_LIMIT", 120) as usize,
            airframe_rate_limit: int("NETWORK_API_AIRFRAME_RATE_LIMIT", 300) as usize,
